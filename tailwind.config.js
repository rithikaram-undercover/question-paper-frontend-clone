  ...
  theme: {
    extend: {
      colors: {
        ...
        "gray1000-black": "var(--gray1000-black)",
      ...
      fontFamily: {
        ...
        "text-14-regular": "var(--text-14-regular-font-family)",
        "text-14-semibold": "var(--text-14-semibold-font-family)",
        "text-16-bold": "var(--text-16-bold-font-family)",
        "text-16-medium": "var(--text-16-medium-font-family)",
        "text-16-semibold": "var(--text-16-semibold-font-family)",
